...
Start-BitsTransfer -Source "https://github.com/Ekisa-Team/ekisa-chatbots-cli/releases/latest/download/ec-windows-amd64.zip" -Destination "ec-windows-amd64.zip"    

# Extract ZIP file
Write-Output "Extracting..."
Expand-Archive "ec-windows-amd64.zip" $installationPath
Remove-Item "ec-windows-amd64.zip" -Force
